                ...
                <div className="container-fluid py-5">
                    <div className="container pt-5">
                        <div className="col-md-10 mx-auto text-center py-5">
                            ...
                            <h1 className="fw-bolder display-4 wow fadeInUp mb-4" data-wow-delay=".2s">Leading Lubricant Manufacturer</h1>
                    ...
                    <div className="row">
                        <div className="col-md-10 mx-auto">
                            <div className="section-title mb-5">
                                ...
                                <Image src={TotalImage} alt="Leading Lubricant Manufacturer" className='img-fluid' width={500} quality={100} />
                        ...
                        <div className='col-md-12 text-center'>
                            <Link className="main-btn" href="/success-stories"><i className="fa-solid fa-arrow-left"></i> Success Stories </Link>
                        </div>
                    </div>
                </div>
            </section >
