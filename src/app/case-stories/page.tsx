                ...
                <div className="container-fluid">
                    <div className="container pt-5">
                        <div className="col-md-10 mx-auto text-center py-5">
                            ...
                            <p className='h6 wow fadeInUp lh-lg' data-wow-delay=".5s">GIS is emerging as a highly intuitive tool that is being used in several industries in various applications today. GIS helps in creating maps that can be used to perform analysis, compare & forecast data, share information etc and thereby helping to resolve multifaceted complications in several areas around the world.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-12 py-5'>
                                        <Link className="main-btn" href="/case-stories/total-energies">Read Case Story <i className="fa-solid fa-arrow-right"></i></Link>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex flex-column flex-column-reverse flex-lg-row gap-5 align-items-center col-md-10 mx-auto">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-12 py-5'>
                                        <Link className="main-btn" href="/case-stories/safefit">Read Case Story <i className="fa-solid fa-arrow-right"></i></Link>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex flex-column flex-column-reverse flex-lg-row gap-5 align-items-center col-md-10 mx-auto">
                            <div className="col-md-6">
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-12 py-5'>
                                        <Link className="main-btn" href="/case-stories/paypark">Read Case Story <i className="fa-solid fa-arrow-right"></i></Link>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex flex-column flex-column-reverse flex-lg-row gap-5 align-items-center col-md-10 mx-auto">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-12 py-5'>
                                        <Link className="main-btn" href="/case-stories/agrotech">Read Case Story <i className="fa-solid fa-arrow-right"></i></Link>
                                    </div>
                                </div>
